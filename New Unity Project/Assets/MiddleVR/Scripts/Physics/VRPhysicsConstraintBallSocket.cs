...
[HelpURL("http://www.middlevr.com/doc/current/#ball-and-socket-constraint")]
...
public class VRPhysicsConstraintBallSocket : MonoBehaviour {
    ...
    protected void Start()
    {
        ...
        {
            MiddleVRTools.Log(0, "[X] No PhysicsManager found when creating a ball-socket constraint.");
            return;
        }
