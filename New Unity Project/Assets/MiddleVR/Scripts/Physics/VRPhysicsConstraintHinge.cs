...
[AddComponentMenu("MiddleVR/Physics/Constraints/Hinge")]
[HelpURL("http://www.middlevr.com/doc/current/#hinge-constraint")]
[RequireComponent(typeof(VRPhysicsBody))]
public class VRPhysicsConstraintHinge : MonoBehaviour {
    ...
    private vrPhysicsConstraintHinge m_PhysicsConstraint = null;
    ...
    public vrPhysicsConstraintHinge PhysicsConstraint
    {
        get
        {
