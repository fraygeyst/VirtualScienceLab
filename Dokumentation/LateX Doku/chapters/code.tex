...
Dieses Script dient zum Szenenwechsel. Es wird bei Berührung eines Türgriffs ausgeführt.
...
Ähnlich des vorherigen Scripts dient dieses Script auch zum Szenenwechsel. Jedoch wird es nur innerhalb des BioLabs auf dem Mikroskop verwendet. Die benötigte Szene wird anhand des auf das Mikroskop gelegten Objekts erkannt.
...
Dieses Script steuert den Licht-Versuch im Elektrolabor. Es funktioniert ähnlich wie das vorherige Script. Gesteuert wird jedoch zusätzlich zu den Anzeigen noch die Helligkeit einer \"Glühbirne\".
...
Dieses Script dient zur Darstellung der Ergebnisse des Frequenz-Versuchs im Elektro Labor. Bei Berührung eines Buttons wird ein Bild mit einer Wertetafel an der Wand angezeigt.
...
Dieses Script dient zur Steuerung der Bewegung der Moleküle im Teilchenlabor. Die Geschwindigkeit wird aus einer globalen Variable genommen und in die Bewegung eingerechnet.
...
Siehe vorheriges Script. Allerdings wird hier die Drehung berechnet.
...
Siehe vorheriges Script. Allerdings wird hier die X-Achsen-Drehung berechnet.
